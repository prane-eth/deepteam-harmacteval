  ...
  return (
    <div className={clsx(styles.tableOfContents, className)}>
      ...
      {/* <div className={styles.promoCard}>
        <img src="/icons/red-logo.svg" alt="Confident AI" className={styles.logo} />
        <div className={styles.heading}>
          Try DeepTeam on Confident AI for FREE
        </div>
        <div className={styles.description}>
          View and save red teaming results, curate datasets and manage
